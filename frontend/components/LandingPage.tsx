...
interface LandingPageProps {
  ...
  onStartCustomerSupport: () => void;
}

export default function LandingPage({ onStartKYC, onStartInvestments, onStartCustomerSupport }: LandingPageProps) {
  return (
            ...
            {(
              [
                ...
                },
                {
                  ...
                  desc: "Real-time AI agent assist with live transcription, RAG-grounded suggestions, and compliance monitoring",
                  onClick: onStartCustomerSupport,
                },
