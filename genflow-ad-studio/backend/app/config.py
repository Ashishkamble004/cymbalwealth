...
class Settings(BaseSettings):
    ...
    image_region: str = Field(
        default="global",
        validation_alias=AliasChoices("image_region", "IMAGE_REGION"),
    )
    text_region: str = Field(
        default="global",
        validation_alias=AliasChoices("text_region", "TEXT_REGION"),
    )
    veo_model: str = Field(
